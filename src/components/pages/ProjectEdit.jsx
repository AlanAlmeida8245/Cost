...
function ProjectEdit() {
  ...
  useEffect(() => {
    // 
        fetch(`https://back-end-costs.vercel.app/projetos/${id}`, {
          method: 'GET',
          headers: {
  ...
  function editPost(project) {
    ...
    fetch(`https://back-end-costs.vercel.app/projetos/${project._id}`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  function createService(project, service) {
    ...
    fetch(`https://back-end-costs.vercel.app/projetos/${project._id}`, { // Adiciona o Serviço no Banco de Dados
        method: "PUT",
        headers: {
            "Content-type": "application/json"
        },
  ...
  function removeService(id, cost) {
    ...
    fetch(`https://back-end-costs.vercel.app/projetos/${projectUpdated._id}/${id}`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
      },
